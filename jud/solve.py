...
x_data = np.linspace(0,1,300)[:, np.newaxis] 
...
for i in range (4000):
	# Q: ??? tensorflow know update the x_data, y_data at each train ???
	# A: feed 100 pairs of data one time, use the same data trainning the model 
	# again and again  
